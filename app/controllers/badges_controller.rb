class BadgesController < ApplicationController
  ...
  def create
    ...
    if @badge.save && @badge.opportunity_id == nil && @badge.signup == nil
      redirect_to "/users/#{@user.id}", notice: "#{@badge.name} badge created!"
...
private
  ...
  def badge_params
    params.require(:badge).permit(:user_id, :opportunity_id, :name, :description, :exp, :education,
    signup_attributes: [:id, :badge_id, :current_step])
  end
end
